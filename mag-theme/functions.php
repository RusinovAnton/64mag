...
function twentyfourteen_widgets_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'sidebar-2',
		'description'   => __( 'Popup subscription menu', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
	...
	register_sidebar( array(
		'name'          => 'Shop Widget',
		'id'            => 'sidebar-4',
		'description'   => __( 'Appears in the shop.', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
...
function subMenus($id, $cats, $cat) {
	$start ="<li class='sub-nav-item'><a href='";
	$middle = "' class='sub-nav-link'>";
	$ending = "</a></li>";
	$subs ='';
	foreach ($cats as $cat) {
		if ($cat->parent == 0){continue;}
		if($cat->parent == $id){
			$subs .= $start . esc_url( get_category_link( $cat->cat_ID )) . $middle . $cat->name . $ending;
		}
	}
	return $subs;
}
