...
jQuery(document).ready(function($) {
    ...
    var overlay, comments, galleryWrap, gallery, container, nextButton, previousButton, info, transitionBegin, photoCounter, thumbsList,
        ...
        imageMeta, titleAndDescription, commentForm, leftColWrapper, thumbActive;
    ...
    var prepareGallery = function( /*dataCarouselExtra*/ ) {
        if (!overlay) {
            ...
            photoCounter = $('<div></div>').
            addClass('photo-counter');

            thumbsList = $('<div></div>').
            addClass('thumbs-carousel');
            leftColWrapper = $('<div></div>')
                .addClass('jp-carousel-left-column-wrapper').append(photoCounter)
    ...
    var methods = {
        ...
        selectSlide: function(slide, animate) {
            ...
            info.find('.photo-counter').text((gallery.find('.jp-carousel-slide.selected').index() + 1) + " / " + gallery.find('.jp-carousel-slide').length)
