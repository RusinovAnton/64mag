...
/*
Plugin Name: Slider
Plugin URI: http://64mag.ru/
Description: Custom slider plugin based on well-known WP slider
Version: 1.0.0
...
{
    $page_cat = add_menu_page('Theme page title', 'Slider', 'manage_options', 'sliders_huge_it_slider', 'sliders_huge_it_slider', plugins_url('images/sidebar.icon.png', __FILE__));
