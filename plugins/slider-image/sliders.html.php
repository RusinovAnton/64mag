  ...
  jQuery('.add_media').on('click', function(){
	...
	jQuery(".wp-media-buttons-icon").click(function() {
		...
		jQuery(".attachment-filters").css("display","none");
						...
						<div class="huge-it-newuploader">
						<input type="button" class="button" name="_unique_name_button" id="_unique_name_button" value="Add Slide" />
						</div>
					...
					case 'image':	?>
						...
						<input class="order_by" type="hidden" name="order_by_<?php echo $rowimages->id; ?>" value="<?php echo $rowimages->ordering; ?>" />
							<div class="image-container">
								...
								<input type="button" class="button<?php echo $rowimages->id; ?> wp-media-buttons-icon editimageicon" name="_unique_name_button<?php echo $rowimages->id; ?>" id="_unique_name_button<?php echo $rowimages->id; ?>" value="Change image" />
							</div>
									</div>
							</div>
							<div class="image-options">
								...
								<div class="link-block">
									...
									<label class="long" for="sl_link_target<?php echo $rowimages->id; ?>">Slide size 1/4</label>
			...
			<div id="postbox-container-1" class="postbox-container">
				<div id="side-sortables" class="meta-box-sortables ui-sortable">
					...
					<ul id="slider-unique-options-list" style='display:none'>
